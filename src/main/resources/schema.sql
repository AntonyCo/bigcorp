...
NULL);
CREATE TABLE MEASURE(ID BIGINT AUTO_INCREMENT PRIMARY KEY, INSTANT TIMESTAMP WITH TIME ZONE NOT NULL,
VALUE_IN_WATT BIGINT NOT NULL, CAPTOR_ID VARCHAR(255));
